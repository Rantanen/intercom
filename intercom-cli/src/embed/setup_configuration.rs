...
pub trait IEnumSetupInstances {
    fn next(&self, celt: u32) -> ComResult<(ComItf<dyn ISetupInstance>, u32)>;
...
pub trait ISetupConfiguration2 {
    fn enum_instances(&self) -> ComResult<ComItf<dyn IEnumSetupInstances>>;

    fn get_instance_for_current_process(&self) -> ComResult<ComItf<dyn ISetupInstance>>;

    fn get_instance_for_path(&self, path: String) -> ComResult<ComItf<dyn ISetupInstance>>;

    fn enum_all_instances(&self) -> ComResult<ComItf<dyn IEnumSetupInstances>>;
}
