...
namespace raw
{
    ...
    {
        static constexpr intercom::IID ID = {0xb5c84f5f,0xb69f,0x3071,{0x7a,0xd6,0x0f,0xea,0x72,0xe8,0x95,0xc4}};
    ...
    {
    public:
        static constexpr intercom::CLSID ID = {0xf2a61371,0xf376,0x3437,{0x70,0xb7,0x46,0x5c,0x76,0x09,0x11,0x3a}};
