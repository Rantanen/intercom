...
namespace raw
{
    ...
    {
        static constexpr IID ID = {0xaa5b7352,0x5d7a,0x35b9,{0x52,0x06,0x14,0x5b,0x04,0x1f,0x2c,0x1c}};
    ...
    {
        static constexpr IID ID = {0x12341234,0x1234,0x1234,{0x12,0x34,0x12,0x34,0x12,0x34,0x00,0x02}};
    ...
    {
        static constexpr IID ID = {0x2b9bddd2,0x31f5,0x3d4b,{0x79,0xa0,0xac,0x8e,0x8d,0x11,0xa9,0x3e}};
    ...
    {
        static constexpr IID ID = {0xffb673d9,0x7896,0x3a4c,{0x4f,0xa8,0xf7,0x24,0x06,0x58,0x8a,0xa1}};

        virtual HRESULT INTERCOM_CC SOk(  ) = 0;
        virtual HRESULT INTERCOM_CC NotImpl(  ) = 0;
        virtual HRESULT INTERCOM_CC Sqrt( double value, double* __out ) = 0;
        virtual HRESULT INTERCOM_CC Tuple( uint32_t value, uint16_t* __out1, uint16_t* __out2 ) = 0;
    };

    struct IClassCreator : IUnknown
    {
        static constexpr IID ID = {0x2e7e23e8,0xf66d,0x3779,{0x6c,0x74,0x61,0x89,0x8d,0x7b,0x40,0xcd}};

        virtual HRESULT INTERCOM_CC CreateRoot( int32_t id, ICreatedClass** __out ) = 0;
        virtual HRESULT INTERCOM_CC CreateChild( int32_t id, IParent* parent, ICreatedClass** __out ) = 0;
    };

    struct ICreatedClass : IUnknown
    {
        static constexpr IID ID = {0x104eb174,0xfd00,0x3ecf,{0x7e,0x0d,0xd9,0x65,0x56,0x42,0x79,0xe7}};

        virtual HRESULT INTERCOM_CC GetId( int32_t* __out ) = 0;
        virtual HRESULT INTERCOM_CC GetParentId( int32_t* __out ) = 0;
    };

    struct IParent : IUnknown
    {
        static constexpr IID ID = {0xcea1c199,0xbf71,0x3b0a,{0x5a,0x4c,0xee,0x3f,0x5a,0x0a,0xe5,0xce}};
    ...
    {
        static constexpr IID ID = {0x6b198a07,0x2d86,0x340e,{0x71,0x7e,0xf4,0x16,0xa3,0x90,0x5d,0x6e}};

        virtual HRESULT INTERCOM_CC GetNew( IRefCountOperations** __out ) = 0;
        virtual uint32_t INTERCOM_CC GetRefCount(  ) = 0;
    };

    struct ISharedInterface : IUnknown
    {
        static constexpr IID ID = {0x1df08ff6,0xaafb,0x37ec,{0x53,0xcf,0xcd,0xe2,0x49,0xce,0xeb,0x4b}};

        virtual uint32_t INTERCOM_CC GetValue(  ) = 0;
        virtual void INTERCOM_CC SetValue( uint32_t v ) = 0;
        virtual HRESULT INTERCOM_CC DivideBy( ISharedInterface* divisor, uint32_t* __out ) = 0;
    };

    struct IErrorSource : IUnknown
    {
        static constexpr IID ID = {0x5505b7b6,0x5ca4,0x3e38,{0x66,0x7b,0xa9,0x82,0x3f,0x1d,0x5a,0x0f}};

        virtual HRESULT INTERCOM_CC StoreError( HRESULT hr, BSTR desc ) = 0;
    };
    ...
    class RefCountOperationsDescriptor
    {
        ...
        static constexpr std::array<IID, 1> INTERFACES = {
    ...
    class CreatedClassDescriptor
    {
        ...
        static constexpr std::array<IID, 3> INTERFACES = {
    ...
    static constexpr IID IID_IRefCount = {0xaa5b7352,0x5d7a,0x35b9,{0x52,0x06,0x14,0x5b,0x04,0x1f,0x2c,0x1c}};
    using IRefCount = test_lib::raw::IRefCount;
    static constexpr IID IID_IPrimitiveOperations = {0x12341234,0x1234,0x1234,{0x12,0x34,0x12,0x34,0x12,0x34,0x00,0x02}};
    using IPrimitiveOperations = test_lib::raw::IPrimitiveOperations;
    static constexpr IID IID_IStatefulOperations = {0x2b9bddd2,0x31f5,0x3d4b,{0x79,0xa0,0xac,0x8e,0x8d,0x11,0xa9,0x3e}};
    using IStatefulOperations = test_lib::raw::IStatefulOperations;
    static constexpr IID IID_IResultOperations = {0xffb673d9,0x7896,0x3a4c,{0x4f,0xa8,0xf7,0x24,0x06,0x58,0x8a,0xa1}};
    using IResultOperations = test_lib::raw::IResultOperations;
    static constexpr IID IID_IClassCreator = {0x2e7e23e8,0xf66d,0x3779,{0x6c,0x74,0x61,0x89,0x8d,0x7b,0x40,0xcd}};
    using IClassCreator = test_lib::raw::IClassCreator;
    static constexpr IID IID_ICreatedClass = {0x104eb174,0xfd00,0x3ecf,{0x7e,0x0d,0xd9,0x65,0x56,0x42,0x79,0xe7}};
    using ICreatedClass = test_lib::raw::ICreatedClass;
    static constexpr IID IID_IParent = {0xcea1c199,0xbf71,0x3b0a,{0x5a,0x4c,0xee,0x3f,0x5a,0x0a,0xe5,0xce}};
    using IParent = test_lib::raw::IParent;
    static constexpr IID IID_IRefCountOperations = {0x6b198a07,0x2d86,0x340e,{0x71,0x7e,0xf4,0x16,0xa3,0x90,0x5d,0x6e}};
    using IRefCountOperations = test_lib::raw::IRefCountOperations;
    static constexpr IID IID_ISharedInterface = {0x1df08ff6,0xaafb,0x37ec,{0x53,0xcf,0xcd,0xe2,0x49,0xce,0xeb,0x4b}};
    using ISharedInterface = test_lib::raw::ISharedInterface;
    static constexpr IID IID_IErrorSource = {0x5505b7b6,0x5ca4,0x3e38,{0x66,0x7b,0xa9,0x82,0x3f,0x1d,0x5a,0x0f}};
