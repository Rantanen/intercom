...
impl<'a, T: Copy> FromWithTemporary<'a, T> for T {
    ...
    fn to_temporary(source: T) -> Result<Self::Temporary, ComError> {
        Ok(source)
    }
...
impl<'a> FromWithTemporary<'a, &'a BStr> for BString {
...
impl<'a> FromWithTemporary<'a, &'a BStr> for &'a str {
...
impl<'a> FromWithTemporary<'a, &'a BStr> for String {
    type Temporary = &'a BStr;
...
impl<'a> FromWithTemporary<'a, BString> for &'a BStr {
...
impl<'a> FromWithTemporary<'a, CString> for &'a BStr {
    type Temporary = BString;
...
impl<'a> FromWithTemporary<'a, &'a str> for &'a BStr {
    type Temporary = BString;
...
impl<'a> FromWithTemporary<'a, String> for &'a BStr {
    type Temporary = BString;
...
impl<'a> FromWithTemporary<'a, &'a CStr> for &'a BStr {
    type Temporary = BString;
...
impl<'a> FromWithTemporary<'a, &'a BStr> for &'a CStr {
    type Temporary = CString;

    fn to_temporary(source: &'a BStr) -> Result<Self::Temporary, ComError> {
        let string = source.to_string().map_err(|_| ComError::E_INVALIDARG)?;
...
impl<'a> FromWithTemporary<'a, &'a BStr> for CString {
    type Temporary = &'a BStr;
    ...
    fn from_temporary(temp: &'a mut Self::Temporary) -> Result<Self, ComError> {
        let string = temp.to_string().map_err(|_| ComError::E_INVALIDARG)?;
...
impl<'a> FromWithTemporary<'a, &'a CStr> for CString {
...
impl<'a> FromWithTemporary<'a, &'a CStr> for &'a str {
    type Temporary = String;
...
impl<'a> FromWithTemporary<'a, &'a CStr> for String {
    type Temporary = &'a CStr;
...
impl<'a> FromWithTemporary<'a, CString> for &'a CStr {
    type Temporary = CString;
...
impl<'a> FromWithTemporary<'a, BString> for &'a CStr {
    type Temporary = CString;
...
impl<'a> FromWithTemporary<'a, &'a str> for &'a CStr {
    type Temporary = CString;
...
impl<'a> FromWithTemporary<'a, String> for &'a CStr {
    type Temporary = CString;
...
impl<'a> FromWithTemporary<'a, &'a CStr> for BString {
    type Temporary = &'a CStr;
